  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md w-[90%] mx-auto pt-[4rem]">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          onClick={downloadPDF}
          className="flex flex-row gap-x-2 justify-center items-center bg-background-gold text-black transform duration-700 ease-in-out hover:bg-background-dark hover:text-white px-4 py-2 rounded-lg"
        >
          Download List
